...
function MainPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData(prev => ({ ...prev, resultHtml: data.data }))
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-amber-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-amber-200">
            ...
            {message.text && (
              <div className={`mb-6 p-4 rounded-lg ${message.type === 'success'
                ...
                <div className="flex items-center">
                  <svg className={`w-5 h-5 mr-2 ${message.type === 'success' ? 'text-green-500' : 'text-red-500'
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 bg-white ${errors.caseType ? 'border-red-300' : 'border-slate-300'
                    }`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 ${errors.caseNumber ? 'border-red-300' : 'border-slate-300'
                    }`}
                />
                {errors.caseNumber && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 ${errors.filingYear ? 'border-red-300' : 'border-slate-300'
                    }`}
                />
                {errors.filingYear && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 ${errors.captcha ? 'border-red-300' : 'border-slate-300'
                    }`}
                />
                {errors.captcha && (
              ...
              <button
                ...
                disabled={isLoading}
                className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-200 transform ${isLoading
            ...
            {formData.resultHtml && (
              <div className="mt-8">
                <h2 className="text-lg font-bold mb-2">Scraped Result</h2>
                <div className="overflow-x-auto border rounded bg-slate-50 p-4" dangerouslySetInnerHTML={{ __html: formData.resultHtml }} />
              </div>
            )}
            {/* Footer Info */}
